...
impl NetworkConfig {
    ...
    /// Configures the number of parallel serialization tasks
...
mod tests {
    ...
    fn test_num_parallel_serialization_tasks() {
        // Create a default network config and verify the number of serialization tasks
        ...
        // Create a network config with the number of serialization tasks set to 1
        let mut network_config = NetworkConfig {
            max_parallel_serialization_tasks: Some(1),
            max_parallel_deserialization_tasks: Some(1),
            ..NetworkConfig::default()
        };

        // Configure the number of serialization tasks and verify that it is not overridden
        network_config.configure_num_serialization_tasks();
        assert_eq!(network_config.max_parallel_serialization_tasks, Some(1));
