...
module vote_lockup::voting_token {
    ...
    /// For depositing $VOTING into a fungible asset store. This can be the veVOTING token, which cannot be deposited
    ...
    /// For withdrawing $VOTING from a veNFT.
    ...
    /// For extracting $VOTING from the veVOTING token when owner withdraws after the lockup has expired.
